...
public class ModelTest {
  ...
  public void blurOneByOneImg() {
    ...
    assertEquals("OneByOneFilter", model.filter(img, blur).getFilename());
  }
  ...
  public void blurImageWithHeightGreaterThanWidth() {
    ...
    assertEquals("ExHeightImageFilter", model.filter(greaterHeightImg, blur).getFilename());
  }
  ...
  public void blurImageWithWidthGreaterThanHeight() {
    ...
    assertEquals("ExWidthImageFilter", model.filter(greaterWidthImg, blur).getFilename());
  }
  ...
  public void blurSmallerThanKernelDimForImage() {
    ...
    assertArrayEquals(new IPixel[][]{{
        ...
        model.filter(img, blur).getImage());
    assertEquals("TwoByTwoFilter", model.filter(img, blur).getFilename());
  }

  //Test for Sharpening
  @Test(expected = IllegalArgumentException.class)
  public void nullEmptyImgSharp() {
    model.filter(new PPMImage(new IPixel[][]{}, "Empty"), sharp);
  }
  ...
  public void sharpOneByOneImg() {
    ...
    assertEquals("OneByOneFilter", model.filter(img, sharp).getFilename());
  }
  ...
  public void sharpImageWithHeightGreaterThanWidth() {
    ...
    assertEquals("ExHeightImageFilter", model.filter(greaterHeightImg, sharp).getFilename());
  }
  ...
  public void sharpImageWithWidthGreaterThanHeight() {
    ...
    assertEquals("ExWidthImageFilter", model.filter(greaterWidthImg, sharp).getFilename());
  }
  ...
  public void sharpSmallerThanKernelDimForImage() {
    ...
    assertArrayEquals(new IPixel[][]{{
        ...
        model.filter(img, sharp).getImage());
    assertEquals("TwoByTwoFilter", model.filter(img, sharp).getFilename());
  }
  ...
  public void validGreaterOddHeightByEvenWidthKernel() {
    ...
    assertEquals("ExImageFilter", model.filter(evenImg, user).getFilename());
  }
  ...
  public void validGreaterOddWidthByEvenHeightKernel() {
    ...
    assertEquals("ExImage2Filter", model.filter(unevenImg, user).getFilename());
  }
  ...
  public void testKernelLargerThanImage() {
    ...
    assertEquals("ExOddImageFilter", model.filter(oddByOddImg, user).getFilename());
  }
  ...
  public void test255Clamping() {
    ...
    assertEquals("ClampingFilter", model.filter(img, user).getFilename());
  }
  ...
  @Test(expected = IllegalArgumentException.class)
  public void nullInputForImport() {
    model.importImage(null);
  }

  @Test(expected = IllegalArgumentException.class)
  public void nullFileForImport() {
    model.importImage(new InputFileManager(null));
  }

  @Test(expected = IllegalArgumentException.class)
  public void nullNonexistentFileForImport() {
    IOManager input = new InputFileManager(new File("InvalidFile"));
    model.importImage(input);
  }

  @Test
  public void testValidFileForInput() {
    IImageCreator board = new CheckboardImageCreator(4, 4);
    IImage checkerboard = new PPMImage(board.createImage().getImage(), "Checkerboard.ppm");
    IOManager input = new InputFileManager(new File("res/Checkerboard.ppm"));
    assertArrayEquals(checkerboard.getImage(), model.importImage(input).getImage());
    assertEquals("res/Checkerboard.ppm", model.importImage(input).getFilename());
  }
  ...
  public void testNullFilename() {
    model.importImage(new InputFilenameManager(null));
  }
  ...
  public void testValidFilename() {
    ...
    assertArrayEquals(checkerboard.getImage(), model.importImage(input).getImage());
    assertEquals(checkerboard.getFilename(), model.importImage(input).getFilename());
  }


  // export model tests
  @Test(expected = IllegalArgumentException.class)
  public void testPPMExportConstructorExceptionDefaultNullImageInModel() throws IOException {
    this.model.exportImage(new PPMExport(null));
  }

  @Test(expected = IllegalArgumentException.class)
  public void testPPMExportConstructorExceptionGivenReaderNullImage() throws IOException {
    this.model.exportImage(new PPMExport(null, new StringWriter()));
  }

  @Test(expected = IllegalArgumentException.class)
  public void testPPMExportConstructorExceptionGivenNullReader() throws IOException {
    this.model.exportImage(new PPMExport(sampleImage, null));
  }

  @Test(expected = IOException.class)
  public void testPPMExportExportMethodWithFailingWriter() throws IOException {
    this.model.exportImage(new PPMExport(sampleImage, this.failingWriter));
  }
  ...
  public void testExportSampleImage() throws IOException {
    ...
    this.model.exportImage(exportSampleImage);
  ...
  public void testExportCheckerboardImage() throws IOException {
    ...
    this.model.exportImage(exportCheckerboard);
    // tests to make sure that the writer's output is correct
