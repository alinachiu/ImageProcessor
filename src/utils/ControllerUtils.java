...
public class ControllerUtils {
  ...
  public static Map<String, Function<Scanner, IPhotoCommands>> getKnownCommands() {
    ...
    knownCommands.putIfAbsent("save", scanner -> new SaveSingleCommand());
    ...
    knownCommands.putIfAbsent("createdefaultimage",
        scanner -> new CreateImageDefaultCommand(Integer.valueOf(scanner.next()),
            Integer.valueOf(scanner.next())));
    knownCommands.putIfAbsent("createimage",
        scanner -> new CreateImageCommand(Integer.valueOf(scanner.next()),
