...
public class AdditionalImageUtils {
  ...
  /**
   * Exports the given image to be the type with the given extension and to have the given
   * filename.
   *
   ...
   */
  public static void exportWithType(IImage image, String filename, String extension)
