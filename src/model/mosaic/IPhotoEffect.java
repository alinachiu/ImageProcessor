...
/**
 * Represents an interface for applying photo effects (such as mosaicking) to images and returning
...
public interface IPhotoEffect {
   ...
   *         operation applied)
   * @throws IllegalArgumentException if any argument is null or if the number of seeds is
   *                                  negative.
   */
