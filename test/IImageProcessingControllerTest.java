...
public class IImageProcessingControllerTest {
  ...
  public void testLoadAll() {
    ...
    assertEquals(
        "Layer #1, Name of Layer: res/correct/flower.jpeg, Image Filename: "
            + "res/correct/flower.jpeg, Visibility: true\n"
            + "Layer #2, Name of Layer: res/correct/flower.png, Image "
            + "Filename: res/correct/flower.png, Visibility: false\n"
            + "Layer #3, Name of Layer: noimage, No Image Associated "
            + "With This Layer, Visibility: false\n"
            + "Number of valid layers created: 3\n"
            + "Current not yet set.\n"
            + "The process has been quit.\n", ap.toString());
  }
  ...
  public void testSaveNothingThere() {
    Readable input = new StringReader("save q");
    Appendable ap = new StringBuilder();
    IImageProcessingController c = new SimpleIImageProcessingController(model, input, ap);
    c.processImage();
  ...
  public void testCreateDefaultCheckerboardImage() {
    ...
    assertEquals(
        "Layer #1, Name of Layer: Checkerboard, Image Filename: Checkerboard,"
            + " Visibility: true\n"
            + "Number of valid layers created: 1\n"
            + "Current not yet set.\n"
            + "The process has been quit.\n", ap.toString());
  ...
  public void testScriptAsReadable() {
    ...
    File f = new File("res/multiLayeredImage");
    deleteDirectory(f);
    File f2 = new File("res/multiLayeredImage1");
    deleteDirectory(f2);
    File f3 = new File("res/multiLayeredImageUpdated");
    deleteDirectory(f3);
    File f4 = new File("res/multiLayeredImageUpdated1");
    deleteDirectory(f4);
    ...
    assertEquals("Invalid input!\n"
        ...
        + "Layer #3, Name of Layer: third, No Image Associated With This Layer,"
        + " Visibility: true\n"
        + "Layer #4, Name of Layer: Checkerboard, Image Filename: Checkerboard,"
        + " Visibility: true\n"
        ...
        + "Invalid command! Try again! Invalid color transformation and/or image"
        + " filename.\n"
        + "Invalid command! Try again! File res/Checkerboard.ppm not found!\n"
        + "Invalid command! Try again! Invalid color transformation and/or image"
        + " filename.\n"
        + "Layer #1, Name of Layer: first, No Image Associated With This Layer,"
        + " Visibility: true\n"
        + "Layer #2, Name of Layer: third, No Image Associated With This Layer,"
        + " Visibility: true\n"
        + "Layer #3, Name of Layer: Checkerboard, Image Filename: Checkerboard,"
        + " Visibility: true\n"
        + "Layer #4, Name of Layer: fourth, No Image Associated With This Layer,"
        + " Visibility: true\n"
        + "Number of valid layers created: 4\n"
        + "Current Layer: Name of Layer: first, No Image Associated With This Layer,"
        + " Visibility: true\n"
        ...
        + "Layer #4, Name of Layer: fourth, No Image Associated With This Layer, "
        + "Visibility: true\n"
        + "Layer #5, Name of Layer: res/correct/flower.png, Image Filename: "
        ...
        + "Layer #5, Name of Layer: res/correct/flower.png, Image Filename: "
        + "res/correct/flower.png, Visibility: true\n"
        + "Layer #6, Name of Layer: Checkerboard, Image Filename: Checkerboard, "
        + "Visibility: true\n"
  ...
  public void testScriptAsFile() {
    File input = new File("res/script2.txt");
    Appendable ap = new StringBuilder();
    IImageProcessingController c = new SimpleIImageProcessingController(model, input, ap);
    c.processImage();

    File f = new File("res/newDir1");
    deleteDirectory(f);
    File f2 = new File("res/newDir");
    deleteDirectory(f2);

    assertEquals("Layer #1, Name of Layer: first, No Image "
        + "Associated With This Layer, Visibility: true\n"
        + "Number of valid layers created: 1\n"
        + "Current Layer: Name of Layer: first, No Image Associated "
        + "With This Layer, Visibility: true\n"
        + "Layer #1, Name of Layer: first, No Image Associated With "
        ...
        + "This Layer, Visibility: true\n"
        + "Number of valid layers created: 3\n"
        + "Current Layer: Name of Layer: second, No Image Associated "
        + "With This Layer, Visibility: true\n"
        + "Layer #1, Name of Layer: first, No Image Associated With "
        + "This Layer, Visibility: true\n"
        + "Layer #2, Name of Layer: third, No Image Associated With "
        + "This Layer, Visibility: true\n"
        + "Number of valid layers created: 2\n"
        + "Current Layer: Name of Layer: third, No Image Associated With "
        + "This Layer, Visibility: true\n"
        + "Invalid command! Try again! Layer does not exist!\n"
        + "Invalid command! Try again! Layer already exists!\n"
        + "Invalid command! Try again! File check.ppm not found!\n"
        + "Invalid command! Try again! File does not exist!\n"
        + "Invalid command! Try again! Operation cannot be performed!\n"
        + "Invalid command! Try again! Operation cannot be performed!\n"
        + "Invalid command! Try again! Operation cannot be performed!\n"
        + "Invalid command! Try again! No topmost visible layer exists!\n"
        + "Invalid input!\n"
        + "Layer #1, Name of Layer: first, No Image Associated With "
        + "This Layer, Visibility: true\n"
        + "Layer #2, Name of Layer: third, No Image Associated With "
        ...
        + "Current Layer: Name of Layer: third, No Image Associated With "
        + "This Layer, Visibility: true\n"
        + "Layer #1, Name of Layer: first, No Image Associated With This "
        + "Layer, Visibility: true\n"
        + "Layer #2, Name of Layer: third, No Image Associated With This "
        + "Layer, Visibility: true\n"
        + "Layer #3, Name of Layer: fourth, No Image Associated With This "
        + "Layer, Visibility: true\n"
        + "Number of valid layers created: 3\n"
        + "Current Layer: Name of Layer: third, No Image Associated With "
        + "This Layer, Visibility: true\n"
        ...
        + "Invalid command! Try again! Layer does not exist!\n"
        + "Invalid command! Try again! File does not exist!\n"
        + "Invalid command! Try again! Invalid color arguments.\n"
        + "Invalid command! Try again! The parameters are invalid to "
        + "create a checkerboard.\n"
        + "Invalid command! Try again! File does not exist!\n"
        + "Invalid command! Try again! File does not exist!\n"
