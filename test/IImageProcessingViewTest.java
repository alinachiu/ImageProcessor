...
/**
 * Represents the test class for {@code IImageProcessingView} to ensure that the views's behavior
...
public class IImageProcessingViewTest {
  ...
  public void failedAppendable() {
    try {
      new SimpleIImageProcessingView(new LayerModel(),
  ...
  public void testRenderMessage() {
    ...
    try {
      new SimpleIImageProcessingView(new LayerModel(), out)
